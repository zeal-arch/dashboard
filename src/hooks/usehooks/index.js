/**
 * Vendored from @uidotdev/usehooks v2.4.1
 * https://github.com/uidotdev/usehooks
 * MIT License (c) 2023 ui.dev
 *
 * Vendored locally so the project is self-contained
 * and does not depend on the npm registry at runtime.
 */
...
export function useLockBodyScroll() {
  React.useLayoutEffect(() => {
    ...
    document.documentElement.style.overflow = "hidden"; // Needed for iOS Safari
